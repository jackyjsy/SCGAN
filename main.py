...
def main(config):
    ...
    elif config.mode == 'test_epoch':
        solver.test_celeba_epoch()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_seg_path', type=str, default='data/CelebA_nocrop/seg_test')
    parser.add_argument('--test_img_path', type=str, default='data/CelebA_nocrop/img_test')
    # Misc
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'test', 'test_seg', 'test_interp', 'test_interp_all','test_epoch','test_single','seg'])
    ...
    parser.add_argument('--celebA_path', type=str, default='/home/songyao/workspace/data/CelebA_nocrop')
